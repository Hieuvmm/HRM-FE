...
import CreateTichket from "pages/SupportTicket/CreateTicket/CreateTichket";
...
const privateRoutes = [
  ...
  { path: routes.TICKET_CREATE, component: CreateTichket },
  { path: routes.TICKET_UPDATE + ":code", component: SupportTicket },
