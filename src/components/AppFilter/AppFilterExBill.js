...
function AppFilterExBill({placeholder, className, status, changeFormSearch, contentStatus}) {
            ...
            <div>
                <Radio.Group onChange={(e) => changeFormSearch('status', e.target.value)} value={status}>
                    <Space direction="vertical">
                        ...
                        <Radio value="CREATED">Chờ duyệt</Radio>
                        <Radio value="REJECT">Từ chối</Radio>
                        <Radio value="APPROVAL">Đã duyệt</Radio>
                    </Space>
                </Radio.Group>
            </div>
        )
...
export default AppFilterExBill;
