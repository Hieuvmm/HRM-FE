...
export default function DetailTransferBillPage({modalCreate, setModalCreate}) {
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <AppInput className={"mb-5"} label={"Nội dung xuất kho"} value={formCreate.desc}
                                      disabled
                                      onChange={(e) =>
                                          handleFormUpdate(
                                              setFormCreate,
