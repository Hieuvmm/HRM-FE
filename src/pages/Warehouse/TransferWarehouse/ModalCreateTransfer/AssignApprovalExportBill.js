...
const {Option} = Select
export default function ModalAssignApprovalExportBill({modalAssignApproval, setModalAssignApproval, refetch}) {
    ...
    const handleAssignApproval = () => {
        ...
        ExportBillWarehouse.assignApproval({
            ...formCreate,
            exportBillCodes: modalAssignApproval?.exBillCodes
        }).then((res) => {
                refetch()
